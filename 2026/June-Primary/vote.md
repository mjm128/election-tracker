...
| Office | My Vote | Party | Core Rationale |
| :--- | :--- | :--- | :--- |
| **Governor** | **Steve Hilton** <br>*(Coordinating with others to vote Chad Bianco)* | Rep | **Vote-Splitting Strategy:** In California's top-two primary, piling all conservative votes onto one candidate guarantees a Democrat takes the second spot. To attempt an all-Republican general election ticket, we are alternating votes within our household/network. I am voting for Hilton (deregulation, market-driven solutions), while coordinating with others to vote for Bianco (law enforcement, public safety). Hilton is currently polling higher than Bianco. https://www.realclearpolling.com/polls/governor/general/2026/california/open_primary |
...
## 🏛️ State Legislative & Board Offices
...
| **Board of Equalization (Dist. 4)**| **Denis Bilodeau** | Rep | Ensuring fiscal restraint on the BOE is critical for protecting tax-optimized investment strategies and keeping property tax burdens in check. |
...
| Office | My Vote | Party | Core Rationale |
| :--- | :--- | :--- | :--- |
| **OC Superintendent** | **Dr. Stefan Bean** | NP | *(Nonpartisan office)* Incumbent and strong advocate for school choice, charter schools, and parental rights. <br><br>**Voting Logistics Note:** The progressive challenger on the sample ballot (Jeff Cole) was disqualified by a judge in March for lacking proper credentials. If Bean's name is not pre-printed on the official mail-in ballot due to printing deadlines, I will use the "Write-In" line to cast my vote for Bean. |

---

## 📝 Next Steps
- [ ] Finalize the decision between the multiple Republican/Libertarian candidates in the U.S. House and Governor races.
- [ ] Review any late-breaking debates or endorsements from local conservative organizations (e.g., OC GOP, Libertarian Party of Orange County, Howard Jarvis Taxpayers Association).
- [ ] Transfer these decisions to the official mail-in ballot.
